...
def divide_mask(input_path, output_path):
    ...
    # Scale the projections to range from 1 to 101.
    scaled_projections = 1 + 100 * (projections - min_proj) / (max_proj - min_proj)
...
if __name__ == "__main__":
    ...
    parser.add_argument('input_path', type=str, help='Path to the input binary mask file.')
    ...
    divide_mask(args.input_path, output_path)
